...
// Daniel Valvano
// September 11, 2013
// Last edit: 5/2/19 by Angel Perez, Eric Nguyen
...
//#define NVIC_ST_RELOAD_M        0x000270FF  // Counter reload value for 10ms 
#define RELOAD        0x000270FF  // Counter reload value for 10ms 
// Initialize SysTick with busy wait running at bus clock.
void SysTick_Init(void){
  NVIC_ST_CTRL_R = 0;                   // disable SysTick during setup
  NVIC_ST_RELOAD_R = 0x000C3500;  // maximum reload value for 10ms 
